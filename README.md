...
[![Build](https://github.com/ao-apps/ao-javadoc-offline/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/ao-apps/ao-javadoc-offline/actions?query=workflow%3ABuild)
